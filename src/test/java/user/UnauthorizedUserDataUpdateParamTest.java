...
public class UnauthorizedUserDataUpdateParamTest {
    ...
    public UnauthorizedUserDataUpdateParamTest(UserPropertiesState email, UserPropertiesState password, UserPropertiesState name, int expectedStatusCode, boolean expectedSuccessState, String expectedMessage) {
        this.email = email;
