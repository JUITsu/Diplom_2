...
public class AuthorizedUserDataUpdateParamTest {
    ...
    public AuthorizedUserDataUpdateParamTest(UserPropertiesState email, UserPropertiesState password, UserPropertiesState name, int expectedStatusCode, boolean expectedSuccessState) {
        this.email = email;
